const FoodDisplay = ({ item }) => {
    ...
    return (
        <div className="group h-72 relative overflow-hidden hover:scale-110 duration-700 mx-1">
            <div>
                <img src={image} alt="Item" className="w-full h-72  object-cover " />
            </div>
            ...
            <div className="absolute hidden  text-white p-4  w-full h-full top-0   group-hover:block  ">
                <div
                    ...
                    className=" bg-black bg-opacity-50  h-full w-full p-5 text-center flex flex-col justify-center content-center items-center  border-2 border-white delay-150  "
                >
                    <h2 className=" m-3 lg:text-lg font-semibold md:text-md  sm:tex-sm  text-gray-200">{name}</h2>
